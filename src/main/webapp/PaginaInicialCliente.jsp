...
/* Centra el carrusel de fotos */
#myCarousel {
	margin: 0 auto;
}

/* Redimensiona las imágenes del carrusel */
.carousel-item img {
	max-width: 100%;
	height: auto;
	margin: 0 auto;
		...
		<div class="collapse navbar-collapse justify-content-right"
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a href="LoginEmpleado"
					class="btn btn-dark" style="color: white;">SESION EMPLEADO</a></li>
			...
			<div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img
							src="https://imagenes.eltiempo.com/files/image_1200_600/uploads/2021/11/04/6184795f1ffc2.jpeg"
							class="d-block mx-auto" alt="First slide">
					</div>
					<div class="carousel-item">
						<img
							src="https://s2.abcstatics.com/media/gurmesevilla/2014/02/solomillo-ternera-vino.jpg "
							class="d-block mx-auto" alt="Second slide">
					</div>
					<div class="carousel-item">
						<img
							src="https://s3.abcstatics.com/media/gurmemalaga/2021/01/platos-cocina-creativa-DESTACADA.jpg"
							class="d-block mx-auto" alt="Third slide">
					</div>
				</div>
